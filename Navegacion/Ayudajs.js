        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.container}>
                ...
                <View style={styles.optionsContainer}>
                    ...
                    <Text style={{ marginLeft: 40 }}>_____________________________________________</Text>
                    <TouchableOpacity style={styles.option}>
                        <Image source={require('../images/politicaskevin.png')} style={styles.iconPerfil} />
                        <View style={styles.optionTextContainer}>
                    ...
                    <Text style={{ marginLeft: 40,marginBottom:50} }>____________________________________________</Text>
